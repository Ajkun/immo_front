...
var SvgIconRegistryService = class _SvgIconRegistryService {
  ...
  static {
    this.ɵfac = function SvgIconRegistryService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _SvgIconRegistryService)(ɵɵinject(SvgLoader), ɵɵinject(PLATFORM_ID), ɵɵinject(SERVER_URL, 8), ɵɵinject(DOCUMENT, 8));
    };
  }
  static {
    this.ɵprov = ɵɵdefineInjectable({
...
var SvgIconComponent = class _SvgIconComponent {
  ...
  static {
    this.ɵfac = function SvgIconComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _SvgIconComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(KeyValueDiffers), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(SvgIconRegistryService), ɵɵdirectiveInject(ChangeDetectorRef));
    };
  }
  static {
