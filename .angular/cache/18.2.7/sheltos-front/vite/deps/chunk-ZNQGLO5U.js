...
var InternalActions = class _InternalActions extends ɵOrderedSubject {
  ...
  static {
    this.ɵfac = /* @__PURE__ */ (() => {
      ...
      return function InternalActions_Factory(__ngFactoryType__) {
        return (ɵInternalActions_BaseFactory || (ɵInternalActions_BaseFactory = ɵɵgetInheritedFactory(_InternalActions)))(__ngFactoryType__ || _InternalActions);
      };
    })();
  }
  static {
...
var PluginManager = class _PluginManager {
  ...
  static {
    this.ɵfac = function PluginManager_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _PluginManager)(ɵɵinject(_PluginManager, 12), ɵɵinject(NGXS_PLUGINS, 8));
    };
  }
  static {
    this.ɵprov = ɵɵdefineInjectable({
...
var StateFactory = class _StateFactory {
  ...
  static {
    this.ɵfac = function StateFactory_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _StateFactory)(ɵɵinject(Injector), ɵɵinject(NgxsConfig), ɵɵinject(_StateFactory, 12), ɵɵinject(InternalActions), ɵɵinject(InternalDispatchedActionResults), ɵɵinject(StateContextFactory), ɵɵinject(ɵINITIAL_STATE_TOKEN, 8));
    };
  }
  static {
    this.ɵprov = ɵɵdefineInjectable({
...
//# sourceMappingURL=chunk-ZNQGLO5U.js.map
